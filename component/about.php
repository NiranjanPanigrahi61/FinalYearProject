...
<body>
    <div class="about-banner fs-5 d-flex flex-column justify-content-center align-items-center text-white text-center min-vh-50"
        style="background-image: url('../assets/about_bg.jpg'); background-size: cover; background-position: center;">
        <h1>About Us</h1>
    </div>
    ...
    <div class="container py-5">
        <section>
            ...
            <p class="lead text-center">
                Silicon New Baking is your go-to destination for delightful baked goods and customizable cakes. Founded
                in
                2024 by three passionate MCA students, Subhendu Behera, Niranjan Panigrahi, and Biswabishal Senapati, we
                aim
        ...
        <section class="mt-5">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item">
                    <a href="<?= BASE_URL ?>pages/Customize.php" class="text-decoration-none text-dark">Customizable
                        cakes for every occasion</a>
                </li>
                <li class="list-group-item">
                    <a href="bakery_products.php" class="text-decoration-none text-dark">Freshly baked bread, biscuits,
                        cookies, and other bakery delights</a>
                </li>
                <li class="list-group-item">
                    <a href="services.php" class="text-decoration-none text-dark">Friendly service and attention to
                        detail in all our offerings</a>
                </li>
            </ul>
        </section>
                    ...
                    <a href="https://www.linkedin.com/in/niranjan-panigrahi56/" class="text-decoration-none">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Combining creativity and dedication, Niranjan brings a unique touch
                                    to
                    ...
                    <a href="https://www.linkedin.com/in/biswabishalsenapati21" class="text-decoration-none">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Driven by a love for quality and detail, Biswabishal ensures every
                                    product
