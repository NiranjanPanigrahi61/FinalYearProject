<footer class="text-white pt-4 mt-4" style="background-color: #E4007C ">
        <div class="container">
            <div class="row">
                ...
                <!-- Contact Us -->
                <div class="col-md-4">
                    <h5 class="fs-3 text-center">Contact Us</h5>
                    <div class="contactinfo ps-5">
                        <p>Email:bakery@gmail.com</p>
                        <p>Phone: +91 7208946835</p>
                        <p>Address: 2 sector 4, Bhubaneswar, India</p>
                        <a href="" class="text-white text-decoration-none"><p>feed back</p></a>
                    </div>
                </div>
                <!-- Follow Us -->
                <div class="col-md-4 text-center">
                    <h5 class="fs-3">Follow Us</h5>
                    <a href="#" class="text-white me-2 d-inline-block">
                    ...
                    <a href="https://www.youtube.com/" class="text-white me-2 d-inline-block">
        ...
        <!-- Copyright Line -->
        <div class="text-center py-3 mt-4" style="background-color: #E33F5C">
